...
Project objectives:
    ...
    Send onboard temperature data to Google Sheets
...
try:
    ...
    # then continuously read temperature and send the data to Google Sheets 
    while True:
        ...
        url = f"https://maker.ifttt.com/trigger/{event_name}/with/key/{key}?value1={temp}"
        ...
        # device reads temperature and sends data to Google Sheets every 5 secs
        sleep(5)
